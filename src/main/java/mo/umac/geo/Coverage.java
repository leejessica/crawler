...
public class Coverage {
	 ...
	 */
	public static Coordinate mileToCoordinates(Coordinate p1, double miles,
			double azimuth) {
	...
	public static Circle computeCircle(Envelope envelope) {
		...
		Coordinate center = new Coordinate(envelope.centre().x,
				envelope.centre().y, 0);
		Coordinate boardPoint = new Coordinate(envelope.getMinX(),
				envelope.getMinY());
