...
import mo.umac.metadata.Level_info;
import mo.umac.metadata.PandC;
...
public class PerpheryQuery_Optimize extends OfflineStrategy{
	...
	public void crawl(String state, int category, String query,
		...
		startQuery(startPoint,state,category,query,visitedQ);
		 System.out.println("=======%%%%%%%%%%%%%===========");
		 System.out.println("2====countpoint="+countpoint);
	}
...
=======
	 ...
	 */
>>>>>>> 16fcefcae96dafaee6143f1e30b7f9f43751769f
