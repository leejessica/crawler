...
public class FileDB extends DataSet {
	...
	@Override
	public void record(int queryID, int level, int parentID, YahooLocalQuery qc, ResultSet resultSet) {
	 ...
	 * @param resultSet
	 */
	private void writeQueryFile(String partFileName, BufferedWriter dbOutput, String queryInfo, ResultSet resultSet) {
		try {
	 ...
	 * @deprecated
	 */
	private void writeQueryFile(String partFileName, YahooLocalQuery qc, ResultSet resultSet) {
